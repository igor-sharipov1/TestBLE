...
public class GlucoseReadings extends BluetoothCHelper {
    ...
    public GlucoseReadings() {}

    public GlucoseReadings(byte[] packet) {
        this(packet, null);
    }

    public GlucoseReadings(byte[] packet, String device) {
        if (packet.length >= 14) {
